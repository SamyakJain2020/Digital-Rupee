...
describe("AliveCore Test", function() {
    it("Deploys AliveCore and creates Bands", async function() {
      const [owner, minter, ] = await ethers.getSigners();
      console.log(owner.address)
      console.log(minter.address)

      const AliveCore = await hre.ethers.getContractFactory("SigTest");
      let alivecore = await AliveCore.deploy();
      await alivecore.deployed();
      
      console.log("AliveCore deployed", alivecore.address);
      let createBand = await alivecore.createBand("Harsh's BAnd"); // creates a empty band
